    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 30; $i++)
        {
            Product::create([
                ...
                'description' => 'Lorem ' . $i . 'ipsum dolor sit amet, consectetur adipiscing elit. 
                Cras viverra sapien id sem ornare convallis. Nullam felis sapien, aliquam a molestie id, lacinia vitae nibh',
            ])->categories()->attach(1);
        }
        ...
        for ($i = 1; $i <= 9; $i++)
        {
            Product::create([
                'name' => 'Phone' . $i,
                'slug' => 'phone-' . $i,
                'details' => [16, 32, 64][array_rand([16, 32, 64])] . ' inch, ' . [7, 8, 9][array_rand([7, 8, 9])] . 'inch screen, 4GHz Quad',
        ...
        for ($i = 1; $i <= 9; $i++)
        {
            Product::create([
                'name' => 'Tablet' . $i,
                'slug' => 'tablet-' . $i,
                'details' => [16, 32, 64][array_rand([16, 32, 64])] . ' inch, ' . [10, 11, 12][array_rand([10, 11, 12])] . 'inch screen, 4GHz Quad',
